...
interface PaasWeimobGuideCouponDetailGetService
{
    ...
    public function execute(WeimobGuideCouponDetailGetRequest $request) : WeimobGuideCouponDetailGetResponse;
}
...
class WeimobGuideCouponDetailGetParam implements \JsonSerializable
{
    ...
    */
    public function setCouponTemplateIds(?array $couponTemplateIds)
    {
...
class WeimobGuideCouponDetailGetData implements \JsonSerializable
{
    ...
    */
    public function setRecommendStartTime(?WeimobGuideCouponDetailGetDataRecommendStartTime $recommendStartTime)
    {
    ...
    */
    public function setRecommendEndTime(?WeimobGuideCouponDetailGetDataRecommendEndTime $recommendEndTime)
    {
    ...
    */
    public function setValidDate(?WeimobGuideCouponDetailGetDataValidDate $validDate)
    {
...
class WeimobGuideCouponDetailGetDataValidDate implements \JsonSerializable
{
    ...
    */
    public function setUseStartTime(?WeimobGuideCouponDetailGetDataUseStartTime $useStartTime)
    {
    ...
    */
    public function setUseEndTime(?WeimobGuideCouponDetailGetDataUseEndTime $useEndTime)
    {
    ...
    */
    public function setValidDateDesc(?string $validDateDesc)
    {
