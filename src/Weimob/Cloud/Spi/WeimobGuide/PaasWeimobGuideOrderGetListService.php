...
namespace Com\Weimob\Cloud\Spi\WeimobGuide;
...
interface PaasWeimobGuideOrderGetListService
{
    ...
    public function execute(WeimobGuideOrderGetListRequest $request) : WeimobGuideOrderGetListResponse;
}
...
class WeimobGuideOrderGetListData implements \JsonSerializable
{
    ...
    */
    public function setBuyerExpandInfoVo(?WeimobGuideOrderGetListDataBuyerExpandInfoVo $buyerExpandInfoVo)
    {
    ...
    */
    public function setBuyerInfo(?WeimobGuideOrderGetListDataBuyerInfo $buyerInfo)
    {
    ...
    */
    public function setCreateTime(?WeimobGuideOrderGetListDataCreateTime $createTime)
    {
    ...
    */
    public function setFinishTime(?WeimobGuideOrderGetListDataFinishTime $finishTime)
    {
    ...
    */
    public function setPaymentInfo(?WeimobGuideOrderGetListDataPaymentInfo $paymentInfo)
    {
    ...
    */
    public function setUpdateTime(?WeimobGuideOrderGetListDataUpdateTime $updateTime)
    {
    ...
    */
    public function setBuyerRemark(?string $buyerRemark)
    {
    ...
    */
    public function setGoodsAmount(?int $goodsAmount)
    {
    ...
    */
    public function setGoodsGuideType(?int $goodsGuideType)
    {
    ...
    */
    public function setGoodsSourceType(?int $goodsSourceType)
    {
    ...
    */
    public function setOrderEntrance(?int $orderEntrance)
    {
    ...
    */
    public function setOutOrderNo(?int $outOrderNo)
    {
    ...
    */
    public function setShouldPayAmount(?int $shouldPayAmount)
    {
    ...
    */
    public function setTotalDiscountAmount(?int $totalDiscountAmount)
    {
...
class WeimobGuideOrderGetListDataBuyerExpandInfoVo implements \JsonSerializable
{
    ...
    */
    public function setAttributionStoreId(?int $attributionStoreId)
    {
    ...
    */
    public function setAttributionStoreName(?string $attributionStoreName)
    {
    ...
    */
    public function setPersonalGuiderName(?string $personalGuiderName)
    {
    ...
    */
    public function setPersonalGuiderStoreId(?int $personalGuiderStoreId)
    {
    ...
    */
    public function setPersonalGuiderWid(?int $personalGuiderWid)
    {
...
class WeimobGuideOrderGetListDataItemList implements \JsonSerializable
{
    ...
    */
    public function setBaseDiscountInfo(?WeimobGuideOrderGetListDataBaseDiscountInfo $baseDiscountInfo)
    {
    ...
    */
    public function setGoodsDiscountInfo(?WeimobGuideOrderGetListDataGoodsDiscountInfo $goodsDiscountInfo)
    {
    ...
    */
    public function setAvailableStoreId(?int $availableStoreId)
    {
    ...
    */
    public function setCloudCustom(?string $cloudCustom)
    {
    ...
    */
    public function setCreateStoreId(?int $createStoreId)
    {
    ...
    */
    public function setGoodsCategoryId(?int $goodsCategoryId)
    {
    ...
    * @param int $goodsCode
    */
    public function setGoodsCode(?int $goodsCode)
    {
    ...
    */
    public function setGoodsDistributionType(?int $goodsDistributionType)
    {
    ...
    */
    public function setGoodsSellMode(?int $goodsSellMode)
    {
    ...
    */
    public function setHasDelivered(?bool $hasDelivered)
    {
    ...
    */
    public function setInvoiceGoodsName(?string $invoiceGoodsName)
    {
    ...
    */
    public function setItemRemarkName(?string $itemRemarkName)
    {
    ...
    * @param int $outItemId
    */
    public function setOutItemId(?int $outItemId)
    {
    ...
    */
    public function setOuterGoodsId(?int $outerGoodsId)
    {
    ...
    */
    public function setOuterMerchantId(?int $outerMerchantId)
    {
    ...
    */
    public function setOuterSkuId(?int $outerSkuId)
    {
    ...
    */
    public function setPointDeductRatio(?int $pointDeductRatio)
    {
    ...
    */
    public function setPrimaryCategory(?int $primaryCategory)
    {
    ...
    */
    public function setProductDetails(?string $productDetails)
    {
    ...
    */
    public function setSecondaryCategory(?int $secondaryCategory)
    {
    ...
    */
    public function setShouldPaymentAmount(?int $shouldPaymentAmount)
    {
    ...
    * @param int $skuAmount
    */
    public function setSkuAmount(?int $skuAmount)
    {
    ...
    */
    public function setSkuBarCode(?int $skuBarCode)
    {
    ...
    * @param int $skuCode
    */
    public function setSkuCode(?int $skuCode)
    {
    ...
    */
    public function setTaxClassificationCode(?int $taxClassificationCode)
    {
...
class WeimobGuideOrderGetListDataBaseDiscountInfo implements \JsonSerializable
{
    ...
    */
    public function setCardDiscountAmount(?int $cardDiscountAmount)
    {
    ...
    */
    public function setCouponCodeDiscountAmount(?int $couponCodeDiscountAmount)
    {
    ...
    */
    public function setCouponDiscountAmount(?int $couponDiscountAmount)
    {
    ...
    */
    public function setDepositExpansionDiscountAmount(?int $depositExpansionDiscountAmount)
    {
    ...
    */
    public function setGiftCardDiscountAmount(?int $giftCardDiscountAmount)
    {
    ...
    */
    public function setMemberPointsDiscountAmount(?int $memberPointsDiscountAmount)
    {
    ...
    */
    public function setMembershipDiscountAmount(?int $membershipDiscountAmount)
    {
    ...
    */
    public function setMerchantDiscountAmount(?int $merchantDiscountAmount)
    {
    ...
    */
    public function setNynjDiscountAmount(?int $nynjDiscountAmount)
    {
    ...
    */
    public function setPayDiscountAmount(?int $payDiscountAmount)
    {
    ...
    */
    public function setPromotionDiscountAmount(?int $promotionDiscountAmount)
    {
    ...
    */
    public function setTieredPriceDiscountAmount(?int $tieredPriceDiscountAmount)
    {
    ...
    */
    public function setUsedMemberPoints(?int $usedMemberPoints)
    {
...
class WeimobGuideOrderGetListDataGoodsDiscountInfo implements \JsonSerializable
{
    ...
    */
    public function setCommonDiscountInfo(?array $commonDiscountInfo)
    {
...
class WeimobGuideOrderGetListDataCommonDiscountInfo implements \JsonSerializable
{
    ...
    */
    public function setAttributionType(?int $attributionType)
    {
    ...
    */
    public function setDiscountObjectType(?int $discountObjectType)
    {
    ...
    * @param int $outCode
    */
    public function setOutCode(?int $outCode)
    {
    ...
    */
    public function setParticipate(?int $participate)
    {
...
class WeimobGuideOrderGetListDataPaymentInfo implements \JsonSerializable
{
    ...
    */
    public function setPaymentItemVoList(?array $paymentItemVoList)
    {
    ...
    */
    public function setPaymentTime(?WeimobGuideOrderGetListDataPaymentTime2 $paymentTime)
    {
    ...
    */
    public function setChannelTrxNo(?int $channelTrxNo)
    {
    ...
    */
    public function setPaymentTypeName(?string $paymentTypeName)
    {
...
class WeimobGuideOrderGetListDataPaymentItemVoList implements \JsonSerializable
{
    ...
    */
    public function setPaymentTime(?WeimobGuideOrderGetListDataPaymentTime $paymentTime)
    {
        $this->paymentTime = $paymentTime;
    }
    ...
    */
    public function setChangeAmount(?int $changeAmount)
    {
    ...
    */
    public function setCustomPayMethodId(?int $customPayMethodId)
    {
    ...
    */
    public function setCustomPayMethodName(?string $customPayMethodName)
    {
    ...
    */
    public function setInteractId(?int $interactId)
    {
    ...
    */
    public function setOverseaInfo(?string $overseaInfo)
    {
    ...
    */
    public function setPartnerMode(?int $partnerMode)
    {
    ...
    */
    public function setSettlementAmount(?int $settlementAmount)
    {
