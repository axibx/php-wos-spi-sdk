...
interface PaasWeimobGuideCrowdDetailGetListService
{
    ...
    public function execute(WeimobGuideCrowdDetailGetListRequest $request) : WeimobGuideCrowdDetailGetListResponse;
}
...
class WeimobGuideCrowdDetailGetListParam implements \JsonSerializable
{
    ...
    */
    public function setCrowIdList(?array $crowIdList)
    {
    ...
    * @param int $guiderId
    */
    public function setGuiderId(?int $guiderId)
    {
