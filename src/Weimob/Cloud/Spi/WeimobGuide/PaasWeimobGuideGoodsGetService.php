...
interface PaasWeimobGuideGoodsGetService
{
    ...
    public function execute(WeimobGuideGoodsGetRequest $request) : WeimobGuideGoodsGetResponse;
}
...
class WeimobGuideGoodsGetParam implements \JsonSerializable
{
    ...
    */
    public function setFilterOption(?WeimobGuideGoodsGetParamFilterOption $filterOption)
    {
...
class WeimobGuideGoodsGetParamFilterOption implements \JsonSerializable
{
    ...
    */
    public function setIsQueryTagInfo(?bool $isQueryTagInfo)
    {
    ...
    */
    public function setIsQueryClassifyInfo(?bool $isQueryClassifyInfo)
    {
    ...
    */
    public function setIsQuerySaleInfo(?bool $isQuerySaleInfo)
    {
    ...
    */
    public function setIsQueryPropertyInfo(?bool $isQueryPropertyInfo)
    {
    ...
    */
    public function setIsQueryCategoryInfo(?bool $isQueryCategoryInfo)
    {
    ...
    */
    public function setIsQueryBrandInfo(?bool $isQueryBrandInfo)
    {
    ...
    */
    public function setIsFilterDeleted(?bool $isFilterDeleted)
    {
    ...
    */
    public function setIsQueryGoodsStockInfo(?bool $isQueryGoodsStockInfo)
    {
    ...
    */
    public function setIsQueryGoodsPriceInfo(?bool $isQueryGoodsPriceInfo)
    {
    ...
    */
    public function setIsQuerySkuInfo(?bool $isQuerySkuInfo)
    {
    ...
    */
    public function setIsQueryActivityInfo(?bool $isQueryActivityInfo)
    {
    ...
    */
    public function setIsQueryActivity(?bool $isQueryActivity)
    {
    ...
    */
    public function setIsQueryActivityPrice(?bool $isQueryActivityPrice)
    {
    ...
    */
    public function setGenerateLinkFlag(?bool $generateLinkFlag)
    {
    ...
    */
    public function setIsQueryItemSkuInfo(?bool $isQueryItemSkuInfo)
    {
    ...
    */
    public function setIsQueryMember(?bool $isQueryMember)
    {
...
class WeimobGuideGoodsGetData implements \JsonSerializable
{
    ...
    */
    public function setGoodsStock(?WeimobGuideGoodsGetDataGoodsStock $goodsStock)
    {
    ...
    */
    public function setGoodsLimit(?WeimobGuideGoodsGetDataGoodsLimit $goodsLimit)
    {
    ...
    */
    public function setPreSellGoods(?WeimobGuideGoodsGetDataPreSellGoods $preSellGoods)
    {
    ...
    */
    public function setSkuSpecList(?array $skuSpecList)
    {
    ...
    */
    public function setGoodsTag(?WeimobGuideGoodsGetDataGoodsTag $goodsTag)
    {
    ...
    */
    public function setOuterGoodsCode(?string $outerGoodsCode)
    {
    ...
    */
    public function setGoodsImageUrl(?array $goodsImageUrl)
    {
    ...
    */
    public function setGoodsVideoUrl(?string $goodsVideoUrl)
    {
    ...
    */
    public function setGoodsVideoImageUrl(?string $goodsVideoImageUrl)
    {
    ...
    */
    public function setGoodsDesc(?string $goodsDesc)
    {
    ...
    */
    public function setLimitSwitch(?bool $limitSwitch)
    {
    ...
    */
    public function setGoodsShowType(?int $goodsShowType)
    {
...
class WeimobGuideGoodsGetDataGoodsLimit implements \JsonSerializable
{
    ...
    */
    public function setGoodsLimitNum(?int $goodsLimitNum)
    {
    ...
    */
    public function setGoodsLimitCycle(?int $goodsLimitCycle)
    {
...
class WeimobGuideGoodsGetDataPreSellGoods implements \JsonSerializable
{
    ...
    */
    public function setFinalPaymentInfo(?WeimobGuideGoodsGetDataFinalPaymentInfo $finalPaymentInfo)
    {
    ...
    */
    public function setDeliveryInfo(?WeimobGuideGoodsGetDataDeliveryInfo $deliveryInfo)
    {
    ...
    */
    public function setDepositPayType(?int $depositPayType)
    {
    ...
    */
    public function setIgnoreChangeType(?int $ignoreChangeType)
    {
    ...
    */
    public function setPresellTimeType(?int $presellTimeType)
    {
    ...
    */
    public function setStartPresellTime(?int $startPresellTime)
    {
    ...
    */
    public function setEndPresellTime(?int $endPresellTime)
    {
    ...
    */
    public function setExpireProcessType(?int $expireProcessType)
    {
    ...
    */
    public function setSelectWarehouseType(?int $selectWarehouseType)
    {
    ...
    */
    public function setGoodsLimitRule(?int $goodsLimitRule)
    {
...
class WeimobGuideGoodsGetDataFinalPaymentInfo implements \JsonSerializable
{
    ...
    */
    public function setFinalPaymentType(?int $finalPaymentType)
    {
    ...
    */
    public function setStartFinalPayTime(?int $startFinalPayTime)
    {
    ...
    */
    public function setEndFinalPayTime(?int $endFinalPayTime)
    {
    ...
    */
    public function setAfterDepositStartFinalDay(?int $afterDepositStartFinalDay)
    {
    ...
    */
    public function setAfterDepositEndFinalDay(?int $afterDepositEndFinalDay)
    {
    ...
    */
    public function setAfterDepositEndFinalHour(?int $afterDepositEndFinalHour)
    {
...
class WeimobGuideGoodsGetDataDeliveryInfo implements \JsonSerializable
{
    ...
    */
    public function setAfterFinalPayDeliveryDay(?int $afterFinalPayDeliveryDay)
    {
    ...
    */
    public function setAfterFinalPayDeliveryHour(?int $afterFinalPayDeliveryHour)
    {
    ...
    */
    public function setScheduleDeliveryTime(?int $scheduleDeliveryTime)
    {
...
class WeimobGuideGoodsGetDataSkuSpecList implements \JsonSerializable
{
    ...
    * @param int $specId
    */
    public function setSpecId(?int $specId)
    {
        $this->specId = $specId;
    }
    ...
    */
    public function setSpecName(?string $specName)
    {
    ...
    */
    public function setSpecImgEnable(?bool $specImgEnable)
    {
...
class WeimobGuideGoodsGetDataSkuList implements \JsonSerializable
{
    ...
    */
    public function setSkuSpecValueList(?array $skuSpecValueList)
    {
...
class WeimobGuideGoodsGetDataSkuSpecValueList implements \JsonSerializable
{
    ...
    */
    public function setSpecValueName(?string $specValueName)
    {
    ...
    */
    public function setSpecValueId(?int $specValueId)
    {
