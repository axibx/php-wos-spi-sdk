...
class SQueryCardTemplateListData implements \JsonSerializable
{
    ...
    */
    public function setBaseInfo(?SQueryCardTemplateListDataBaseInfo $baseInfo)
    {
...
class SQueryCardTemplateListDataBaseInfo implements \JsonSerializable
{
    ...
    */
    public function setBackgroundType(?int $backgroundType)
    {
    ...
    */
    public function setUserTakeLimit(?int $userTakeLimit)
    {
    ...
    */
    public function setExpireDate(?int $expireDate)
    {
    ...
    */
    public function setStartDayCount(?int $startDayCount)
    {
    ...
    */
    public function setExpDayCount(?int $expDayCount)
    {
    ...
    */
    public function setUseAllStore(?bool $useAllStore)
    {
    ...
    */
    public function setCodeGenerateType(?int $codeGenerateType)
    {
