...
interface PaasWeimobCdpCouponReceiveService
{
    ...
    public function execute(WeimobCdpCouponReceiveRequest $request) : WeimobCdpCouponReceiveResponse;
}
...
class WeimobCdpCouponReceiveParam implements \JsonSerializable
{
    ...
    */
    public function setCouponNums(?array $couponNums)
    {
    ...
    * @param int $sceneId
    */
    public function setSceneId(?int $sceneId)
    {
    ...
    */
    public function setIsPreReceive(?bool $isPreReceive)
    {
...
class WeimobCdpCouponReceiveData implements \JsonSerializable
{
    ...
    */
    public function setCouponResultList(?array $couponResultList)
    {
...
class WeimobCdpCouponReceiveDataCouponResultList implements \JsonSerializable
{
    ...
    */
    public function setFailureNum(?int $failureNum)
    {
