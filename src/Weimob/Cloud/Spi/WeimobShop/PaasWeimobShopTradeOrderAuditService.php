...
interface PaasWeimobShopTradeOrderAuditService
{
    ...
    public function execute(WeimobShopTradeOrderAuditRequest $request) : WeimobShopTradeOrderAuditResponse;
}
...
class WeimobShopTradeOrderAuditParam implements \JsonSerializable
{
    ...
    */
    public function setBasicInfo(?WeimobShopTradeOrderAuditParamBasicInfo $basicInfo)
    {
    ...
    */
    public function setExtendInfo(?WeimobShopTradeOrderAuditParamExtendInfo $extendInfo)
    {
...
class WeimobShopTradeOrderAuditParamOrderList implements \JsonSerializable
{
    ...
    */
    public function setPaymentInfo(?WeimobShopTradeOrderAuditParamPaymentInfo $paymentInfo)
    {
    ...
    */
    public function setCustomFieldList(?array $customFieldList)
    {
...
class WeimobShopTradeOrderAuditParamGoodsList implements \JsonSerializable
{
    ...
    */
    public function setGoodsExtMap(?WeimobShopTradeOrderAuditParamGoodsExtMap $goodsExtMap)
    {
    ...
    */
    public function setItemProductInfo(?WeimobShopTradeOrderAuditParamItemProductInfo $itemProductInfo)
    {
    ...
    */
    public function setItemMessageList(?array $itemMessageList)
    {
...
class WeimobShopTradeOrderAuditParamGoodsAbilityList implements \JsonSerializable
{
    ...
    */
    public function setAbilityDetailInfo(?WeimobShopTradeOrderAuditParamAbilityDetailInfo $abilityDetailInfo)
    {
...
class WeimobShopTradeOrderAuditParamPaymentInfo implements \JsonSerializable
{
    ...
    */
    public function setDeductibleAssets(?array $deductibleAssets)
    {
...
class WeimobShopTradeOrderAuditData implements \JsonSerializable
{
    ...
    */
    public function setCommitInfo(?WeimobShopTradeOrderAuditDataCommitInfo $commitInfo)
    {
...
class WeimobShopTradeOrderAuditDataCommitInfo implements \JsonSerializable
{
    ...
    */
    public function setAllowCommit(?bool $allowCommit)
    {
    ...
    */
    public function setUnCommitReason(?bool $unCommitReason)
    {
