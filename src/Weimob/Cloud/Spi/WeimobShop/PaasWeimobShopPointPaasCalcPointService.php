...
namespace Com\Weimob\Cloud\Spi\WeimobShop;
...
class WeimobShopPointPaasCalcPointParam implements \JsonSerializable
{
    ...
    */
    public function setParams(?WeimobShopPointPaasCalcPointParamParams2 $params)
    {
        $this->params = $params;
    }
...
class WeimobShopPointPaasCalcPointParamParams2 implements \JsonSerializable
{
    ...
    */
    public function setBasicInfo(?WeimobShopPointPaasCalcPointParamBasicInfo $basicInfo)
    {
    ...
    */
    public function setExtendInfo(?WeimobShopPointPaasCalcPointParamExtendInfo $extendInfo)
    {
    ...
    */
    public function setInputUserDiscountList(?WeimobShopPointPaasCalcPointParamInputUserDiscountList $inputUserDiscountList)
    {
    ...
    */
    public function setAssetDeductionRule	(?array $assetDeductionRule	)
    {
...
class WeimobShopPointPaasCalcPointParamGoodsTradeMetas implements \JsonSerializable
{
    ...
    */
    public function setBasicGoodsInfo(?WeimobShopPointPaasCalcPointParamBasicGoodsInfo $basicGoodsInfo)
    {
    ...
    */
    public function setMutex(?WeimobShopPointPaasCalcPointParamMutex $mutex)
    {
        $this->mutex = $mutex;
    }
    ...
    */
    public function setPostageDiscountInfo(?WeimobShopPointPaasCalcPointParamPostageDiscountInfo $postageDiscountInfo)
    {
    ...
    */
    public function setTradeGoodsInfo(?WeimobShopPointPaasCalcPointParamTradeGoodsInfo $tradeGoodsInfo)
    {
...
class WeimobShopPointPaasCalcPointParamBasicGoodsInfo implements \JsonSerializable
{
    ...
    */
    public function setPreSellInfo(?WeimobShopPointPaasCalcPointParamPreSellInfo $preSellInfo)
    {
...
class WeimobShopPointPaasCalcPointParamPostageDiscountInfo implements \JsonSerializable
{
    ...
    */
    public function setMutex(?WeimobShopPointPaasCalcPointParamMutex2 $mutex)
    {
        $this->mutex = $mutex;
    }
...
class WeimobShopPointPaasCalcPointData implements \JsonSerializable
{
    ...
    */
    public function setData(?WeimobShopPointPaasCalcPointDataData2 $data)
    {
        $this->data = $data;
    }
...
class WeimobShopPointPaasCalcPointDataGoodsTradeMetas implements \JsonSerializable
{
    ...
    */
    public function setPostageDiscountInfo(?WeimobShopPointPaasCalcPointDataPostageDiscountInfo $postageDiscountInfo)
    {
        $this->postageDiscountInfo = $postageDiscountInfo;
    }
    ...
    */
    public function setTradeGoodsInfo(?WeimobShopPointPaasCalcPointDataTradeGoodsInfo $tradeGoodsInfo)
    {
        $this->tradeGoodsInfo = $tradeGoodsInfo;
    }
...
class WeimobShopPointPaasCalcPointDataPostageDiscountInfo implements \JsonSerializable
{
    ...
    */
    public function setMutex(?WeimobShopPointPaasCalcPointDataMutex $mutex)
    {
        $this->mutex = $mutex;
    }
...
class WeimobShopPointPaasCalcPointDataTradeGoodsInfo implements \JsonSerializable
{
    ...
    */
    public function setTradePrice(?int $tradePrice)
    {
        $this->tradePrice = $tradePrice;
    }
...
class WeimobShopPointPaasCalcPointDataCalcRuleList implements \JsonSerializable
{
    ...
    */
    public function setMutex(?WeimobShopPointPaasCalcPointDataMutex2 $mutex)
    {
        $this->mutex = $mutex;
    }
    ...
    */
    public function setDiscountUseInfo(?WeimobShopPointPaasCalcPointDataDiscountUseInfo $discountUseInfo)
    {
