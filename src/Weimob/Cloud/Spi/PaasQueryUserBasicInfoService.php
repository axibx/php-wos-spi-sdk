...
class SQueryUserBasicInfoData implements \JsonSerializable
{
    ...
    */
    public function setChannelStatuses(?array $channelStatuses)
    {
    ...
    */
    public function setAppChannel(?int $appChannel)
    {
    ...
    */
    public function setGetChannel(?int $getChannel)
    {
    ...
    */
    public function setGetChannelId(?int $getChannelId)
    {
    ...
    */
    public function setOuterStr(?string $outerStr)
    {
    ...
    */
    public function setCardPublishTime(?int $cardPublishTime)
    {
    ...
    * @param int $gmtCreate
    */
    public function setGmtCreate(?int $gmtCreate)
    {
...
class SQueryUserBasicInfoDataChannelStatuses implements \JsonSerializable
{
    ...
    */
    public function setThirdCode(?string $thirdCode)
    {
